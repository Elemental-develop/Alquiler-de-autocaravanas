...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Producto.objects.create(
            nombre = 'Autocaravana alquiler Giottiline Siena 385 Privilege',
            marca = 'Giottiline',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana alquiler Sunlight T65',
            marca = 'Sunlight',
            modelo = 'T65',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Continental 840 XT',
            marca = 'Continental',
            modelo = '840 XT',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Challenger C256',
            marca = 'Challenger',
            modelo = 'C256',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Across 660',
            marca = 'Across',
            modelo = '660',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Benimar Sport 346 Alpha',
            marca = 'Benimar',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Benimar Tessoro 442',
            marca = 'Benimar',
            modelo = 'Tessoro 442',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Continental 650 XT',
            marca = 'Continental',
            modelo = '650 XT',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Elnagh Baron 573',
            marca = 'Elnagh',
            modelo = 'Baron 573',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Etrusco 7300 DB',
            marca = 'Etrusco',
            modelo = '7300 DB',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Etrusco I 7400 QB',
            marca = 'Etrusco',
            modelo = 'I 7400 QB',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Giottiline 330 Privilege',
            marca = 'Giottiline',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Giottiline 385 Privilege',
            marca = 'Giottiline',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler JOA CAMP J75T',
            marca = 'JOA CAMP',
            modelo = 'J75T',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler JOA CAMP J70T',
            marca = 'JOA CAMP',
            modelo = 'J70T',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Mclouis Glamys 222',
            marca = 'Mclouis',
            modelo = 'Glamys 222',
        ...
        Producto.objects.create(
            nombre = 'Autocaravana de alquiler Mclouis Glamys 322',
            marca = 'Mclouis',
            modelo = 'Glamys 322',
